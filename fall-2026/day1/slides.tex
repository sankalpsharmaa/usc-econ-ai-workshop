        ...
        \begin{columns}[T,onlytextwidth]
            \begin{column}{0.32\linewidth}
                \begin{block}{\large Self-driving cars}
                    \includegraphics[width=\linewidth]{figures/waymo.jpg}
                \end{block}
            \end{column}
            \begin{column}{0.32\linewidth}
                \begin{block}{\large Weather forecasting}
                    \includegraphics[width=\linewidth]{figures/weather.png}
                \end{block}
            \end{column}
            \begin{column}{0.32\linewidth}
                \begin{block}{\large Chess}
                    \includegraphics[width=\linewidth]{figures/alphachess.jpg}
                \end{block}
            \end{column}
        \end{columns}
    \end{minipage}
...
\begin{frame}{LLM  Evals: Mathematics}
    ...
    % \begin{center}
    \includegraphics[width=0.8\textwidth]{figures/epochai_math.png}\\
    % \end{center}
...
\begin{frame}{LLM Evals: Software Engineering}
    \label{app:swe_bench}
    % \begin{center}
    \includegraphics[width=0.8\textwidth]{figures/epochai_swe.png}\\
